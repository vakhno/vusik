...
const Page = async ({ params, searchParams }: Props) => {
	...
	if (userId) {
		...
		await Promise.all([
			prefetchQuery_getProfile({ userId, queryClient }),
			queryPrefetchGetProfileAnimals({ searchParams, userId, queryClient }),
			queryPrefetchGetProfileAnimalsFilter({ searchParams, userId, queryClient }),
			queryPrefetchGetProfileShelters({ searchParams, userId, queryClient }),
			queryPrefetchGetProfileSheltersFilter({ searchParams, userId, queryClient }),
		]);
