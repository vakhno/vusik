...
async function getAvailableAnimalOptions(
	filters: SelectedFiltersType = {},
): Promise<{ availableOptions: AvailableFiltersType; shelters: ShelterType[] }> {
...
const Index = async ({ searchParams }: Props): Promise<NextResponse<SuccessResponse | ErrorResponse>> => {
	try {
		...
		return NextResponse.json({ success: true, availableOptions, selectedOptions, shelters }, { status: 200 });
	} catch (_) {
