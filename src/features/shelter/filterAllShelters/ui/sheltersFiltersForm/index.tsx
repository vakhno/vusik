...
import { query_getAllSheltersFilter } from "@/features/shelter/filterAllShelters/model/query/fetchAllSheltersFilters";
...
const Index = ({ className = "", searchParams }: Props) => {
	...
	const { data: fetchedData } = query_getAllSheltersFilter({
