...
import { queryGetProfileSheltersFilter } from "@/entities/shelter/model/query/sheltersAllByPageProfileFilters";
...
const Index = ({ userId, className = "", searchParams, filterChage }: Props) => {
	...
	const { data: dataOptions } = queryGetProfileSheltersFilter({
		id: userId,
